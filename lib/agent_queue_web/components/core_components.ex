defmodule AgentQueueWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AgentQueueWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AgentQueueWeb.Gettext, "errors", msg, opts)
    end
  end
